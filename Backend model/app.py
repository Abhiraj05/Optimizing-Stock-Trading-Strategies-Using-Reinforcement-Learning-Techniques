...
#         'timesofindia.indiatimes.com','economictimes.indiatimes.com','thehindubusinessline.com','thehindu.com'
#     ]
#     try:
...
hdfc_model = load_model(
    r"C:\Users\Abhiraj Shilkar\OneDrive\Documents\myproject\Backend model\models\open_close_high_low_hdfcbank.keras")
hdfc_meta = joblib.load(
    r"C:\Users\Abhiraj Shilkar\OneDrive\Documents\myproject\Backend model\models\hdfcbank_extended.pkl")
...
mrf_model = load_model(
    r"C:\Users\Abhiraj Shilkar\OneDrive\Documents\myproject\Backend model\models\open_close_high_low_mrf.keras")
mrf_meta = joblib.load(
    r"C:\Users\Abhiraj Shilkar\OneDrive\Documents\myproject\Backend model\models\mrf_extended.pkl")
